...
Route::prefix(prefix: 'admin-home')->group(function () {
    //team member
...
// API Routes
Route::get('/api/products', [ApiProductsController::class, 'index']);
Route::get('/api/products/{id}', [ApiProductsController::class, 'show']);
Route::get('/api/image', 'ImageController@getImagePath');
Route::get('/api/filters', [ApiProductsController::class, 'availableFilters']);
Route::get('/api/settings', [ApiProductsController::class, 'getSettings']);

Route::get('/admin-home/g/settings', [SettingController::class, 'index'])->name('admin.settings.index');
Route::put('/admin-home/g/settings/update', [SettingController::class, 'update'])->name('admin.settings.update');

Route::get('/admin-home/products/color/{id}', [ColorController::class, 'show'])->name('admin.products.color');
Route::post('/admin-home/products/colors', 'ColorController@store')->name('colors.store');

Route::post('/admin-home/colors/{colorId}/add-image', 'ColorController@addImage')->name('colors.add.image');
Route::post('/admin-home/colors/{id}/delete-image', 'ColorController@deleteImage')->name('colors.delete.image');

Route::get('/admin-home/products/colors/{id}/edit', 'ColorController@edit')->name('admin.product.color.edit');
Route::delete('/admin-home/products/colors/{id}', 'ColorController@delete')->name('admin.product.color.delete');
...
| ADMIN PANEL ROUTES
|----------------------------------------------------------------------------------------------------------------------------*/
Route::prefix(prefix: 'admin-home')->middleware(['setlang:backend', 'adminglobalVariable'])->group(function () {
...
Route::prefix('admin-home')->middleware(['setlang:backend', 'adminglobalVariable'])->group(function () {
    ...
    |----------------------------------------------------------------------------------------------------------------------------*/
    //homepage manage
    Route::prefix(prefix: 'home-page')->group(function () {
        //header slider
    ...
    Route::prefix('contact-page')->group(function () {
        Route::get('/data', 'ContactPageController@index')->name('admin.contact.page.data');
    ...
    Route::get('/new-travel', 'TravelController@new_travel')->name('admin.travel.new');
    Route::post('/new-travel', 'TravelController@store_new_travel');
    Route::get('/travel-edit/{id}', 'TravelController@edit_travel')->name('admin.travel.edit');
    Route::post('/travel-update/{id}', 'TravelController@update_travel')->name('admin.travel.update');
    Route::post('/travel-delete/{id}', 'TravelController@delete_travel')->name('admin.travel.delete');
    Route::post('/travel-bulk-action', 'TravelController@bulk_action_travel')->name('admin.travel.bulk.action');
    Route::post('/travel/clone', 'TravelController@clone_travel')->name('admin.travel.clone');
    //category
    ...
    |  products route
    |----------------------------------------------------------------------------------------------------------------------------*/
    Route::prefix(prefix: 'products')->namespace('Product')->group(function () {
        //products
        Route::post('/bulk-download-qr', 'ProductsController@bulkDownloadQR')->name('admin.products.bulk.download.qr');

        Route::get('/download-qr/{id}', 'ProductsController@downloadQR')->name('download.qr');
        ...
        // ColorController@show and send the product id
        //product ratings
