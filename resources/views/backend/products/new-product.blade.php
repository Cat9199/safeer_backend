                    ...
                    <form action="{{route('admin.products.new')}}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <div class="tab-content margin-top-40">
                            ...
                            <div class="tab-pane fade @if($loop->first) show active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title[{{$lang->slug}}]"
                                        placeholder="{{__('Title')}}">
                                </div>
                                <div class="form-group">
                                    <label for="slug">{{__('Slug')}}</label>
                                    <input type="text" class="form-control" id="slug" name="slug[{{$lang->slug}}]"
                                        placeholder="{{__('slug')}}">
                                </div>
                                <div class="form-group" style="display: none">
                                    <label for="badge">{{__('Badge')}}</label>
                                    <input type="text" class="form-control" id="badge" name="badge[{{$lang->slug}}]"
                                        placeholder="{{__('eg: New')}}" value="0">
                                </div>
                                <div class="form-group">
                                ...
                                @php $attributes = ['material','room_type','application','shape']; @endphp
                                ...
                                <div class="form-group attributes-field">
                                    ...
                                    <div class="attribute-field-wrapper" data-language="{{$lang->slug}}">
                                        <input type="text" class="form-control" id="attributes"
                                            ...
                                            value="{{$attribute}}" type="hidden" style="display: none">

                                        <label for="attributes_description">{{ $attribute}}</label>
                                        <textarea name="attributes_description[{{$lang->slug}}][]" class="form-control"
                                            rows="1" placeholder="{{__('Value')}}"></textarea>
                                ...
                                <div class="row" style="display: none">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="og_meta_description[{{$lang->slug}}]" class="form-control"
                                            rows="5" id="og_meta_description"></textarea>
                                    </div>
                                </div>
                                <div class="row" style="display: none">
                                    <div class="form-group col-md-6">
                        ...
                        <div class="row" style="">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="regular_price" name="regular_price"
                                    placeholder="{{__('Size Width')}}" value="100">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="sale_price">{{__('Size Height')}}</label>
                                <input type="number" class="form-control" id="sale_price" name="sale_price"
                                    placeholder="{{__('Size Height')}}" value="100">
                            </div>
                        </div>
                        <div class="row" style="display: none">
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn"
                                    data-btntitle="Select Product Image" data-modaltitle="Upload Product Image"
