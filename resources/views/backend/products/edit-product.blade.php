            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.products.update')}}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($loop->first) active @endif" data-toggle="tab"
                                    href="#slider_tab_{{$lang->slug}}" role="tab" aria-controls="home"
                        ...
                        <div class="tab-content margin-top-40">
                            ...
                            <div class="tab-pane fade @if($loop->first) show active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title[{{$lang->slug}}]"
                                        value="{{$data->title}}" placeholder="{{__('Title')}}">
                                </div>
                                <div class="form-group">
                                    <label for="slug">{{__('Slug')}}</label>
                                    <input type="text" class="form-control" name="slug[{{$lang->slug}}]"
                                        value="{{$data->slug}}" placeholder="{{__('slug')}}">
                                </div>
                                <div class="form-group" style="display: none">
                                    <label for="badge">{{__('Badge')}}</label>
                                    <input type="text" class="form-control" name="badge[{{$lang->slug}}]"
                                        value="{{$data->badge}}" placeholder="{{__('eg: New')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="short_description[{{$lang->slug}}]" id="short_description"
                                        class="form-control max-height-120" cols="30" rows="4"
                                        placeholder="{{__('Short Description')}}">{{$data->short_description}}</textarea>
                                </div>
                                <div class="form-group attributes-field">
                                    ...
                                    <div class="attribute-field-wrapper" data-language="{{$lang->slug}}">
                                        <input type="text" class="form-control" id="attributes"
                                            name="attributes_title[{{$lang->slug}}][]" value="{{$att_title}}">
                                        <textarea name="attributes_description[{{$lang->slug}}][]" class="form-control"
                                            rows="5">{{purify_html($att_descr[$key]) ?? ''}}</textarea>
                                        <div class="icon-wrapper">
                                            <span class="add_attributes" data-lang="{{$lang->slug}}"><i
                                    ...
                                    <div class="attribute-field-wrapper">
                                        <input type="text" class="form-control" id="attributes"
                                            name="attributes_title[{{$lang->slug}}][]" placeholder="{{__('Title')}}">
                                        <textarea name="attributes_description[{{$lang->slug}}][]" class="form-control"
                                            rows="5" placeholder="{{__('Value')}}"></textarea>
                                        <div class="icon-wrapper">
                                            <span class="add_attributes" data-lang="{{$lang->slug}}"><i
                                                    class="ti-plus"></i></span>
                                        </div>
                                ...
                                <div class="row" style="display: none">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="meta_title[{{$lang->slug}}]"
                                            value="{{$data->meta_title}}" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="og_meta_title">{{__('OG Meta Title')}}</label>
                                        <input type="text" name="og_meta_title[{{$lang->slug}}]"
                                            value="{{$data->og_meta_title}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="meta_description">{{__('Meta Description')}}</label>
                                        <textarea name="meta_description[{{$lang->slug}}]" class="form-control" rows="5"
                                            id="meta_description">{{$data->meta_description}}</textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="og_meta_description">{{__('OG Meta Description')}}</label>
                                        <textarea name="og_meta_description[{{$lang->slug}}]" class="form-control"
                                            rows="5" id="og_meta_description">{{$data->og_meta_description}}</textarea>
                                    </div>
                                </div>
                                <div class="row" style="display: none">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="meta_tags[{{$lang->slug}}]" class="form-control"
                                            data-role="tagsinput" id="meta_tags" value="{{$data->meta_tags}}">
                                    </div>
                                    <div class="form-group col-md-6" style="display: none">
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            ...
                                            <input type="hidden" id="og_meta_image[{{$lang->slug}}]"
                                                name="og_meta_image[{{$lang->slug}}]" value="{{$data->og_meta_image}}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" class="form-control" id="category">
                                ...
                                <option @if($product->category_id == $category->id) selected @endif
                                    value="{{$category->id}}">{{purify_html($category->lang->name)}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="regular_price">{{__('Size Width')}}</label>
                                <input type="number" class="form-control" id="regular_price" name="regular_price"
                                    value="{{$product->regular_price}}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="sale_price">{{__('Size Height')}}</label>
                        ...
                        <div class="row" style="display: none">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="stock_status" class="form-control" id="stock_status">
                                    <option @if($product->stock_status == 'in_stock') selected @endif
                                        value="in_stock">{{__('In Stock')}}</option>
                                    <option @if($product->stock_status == 'out_stock') selected @endif
                                        value="out_stock">{{__('Out Of Stock')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group" style="display: none">
                            ...
                            <label class="switch">
                                <input type="checkbox" @if($product->is_downloadable) checked @endif
                                name="is_downloadable" id="is_downloadable">
                        ...
                        <x-fields.image :name="'image'" :id="$product->image" :title="__('Image')"
                            :dimentions="'1920 x 1280'" />
                        <div class="form-group" style="display: none">
                            ...
                            <div class="media-upload-btn-wrapper">
                                <div class="img-wrap">
                                    ...
                                    <div class="attachment-preview">
                                        <div class="thumbnail">
                                            <div class="centered">
                                                <img class="avatar user-thumb" src="{{$work_section_img['img_url']}}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <button type="submit" id="save" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Save
                            Changes')}}</button>
                    </form>
                </div>
            </div>
